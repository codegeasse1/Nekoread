...
interface MangaDao {
    ...
    @Query("UPDATE manga SET inLibrary = 0, category = 'Reading', lastReadTimestamp = 0, lastReadChapterId = NULL, lastReadChapterName = NULL, lastReadPage = 1 WHERE inLibrary = 1")
