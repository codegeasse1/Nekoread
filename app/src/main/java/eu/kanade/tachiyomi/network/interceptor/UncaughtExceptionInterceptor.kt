 ...
 *
 * Also required by name by extension-lib 1.6 sources (KeiSource): they assert that the app's
 * default client contains one, exactly like Mihon/Tadami's default client.
 *
